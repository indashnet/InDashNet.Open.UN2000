...
#### remark by ________
/devices/virtual/block/nandi            auto                vfat    defaults                                                                wait,check,voldmanaged=sdcard:auto
...
#### ________
#/devices/virtual/block/nandi            auto                vfat    defaults                                                                wait,check,voldmanaged=extsd:auto
#/devices/platform/sunxi-mmc.2/mmc_host  auto                vfat    defaults                                                                wait,check,voldmanaged=extsd:auto
...
#/devices/platform/sunxi-mmc.3/mmc_host  auto                vfat    defaults                                                                wait,check,voldmanaged=sdcard2:auto
#/devices/platform/sw-ehci.1             /mnt/usbhost                vfat    defaults                                                                wait,check,voldmanaged=usbhost:auto
#/devices/platform/sw_hcd_host0          /mnt/usbhost                vfat    defaults                                                                wait,check,voldmanaged=usbhost:auto
#/devices/platform/sw-ohci.1             /mnt/usbhost                vfat    defaults                                                                wait,check,voldmanaged=usbhost:auto
#/dev/block/zram0 none swap defaults zramsize=134217728
