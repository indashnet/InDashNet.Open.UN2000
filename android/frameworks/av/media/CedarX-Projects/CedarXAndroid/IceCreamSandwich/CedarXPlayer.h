...
//    status_t setDataSource_l(const sp<MediaExtractor> &extractor);
    ...
    int mDynamicRotation;   //vdeclib dynamic rotate, clock wise. 0: no rotate, 1: 90 degree (clock wise), 2: 180, 3: 270, 4: horizon flip, 5: vertical flig; reverse to mediaplayerinfo.h, VideoRotateAngle_0.
    int mInitRotation;    //record vdeclib init rotate. clock wise.

    int m3dModeDoubleStreamFlag;    //indicate if the file is 3d double stream.
    bool mIsDRMMedia;
    bool mHDMIPlugged;
