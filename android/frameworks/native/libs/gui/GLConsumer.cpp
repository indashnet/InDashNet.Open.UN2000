...
nsecs_t GLConsumer::getTimestamp() {
    ...
    {
        return mConsumer->getTimestamp();//todo
    }
}
...
Rect GLConsumer::getCurrentCrop() const {
	...
	{
		outCrop = mConsumer->getCrop();//todo
	}
...
uint32_t GLConsumer::getCurrentTransform() const {
    ...
    {
        return mConsumer->getCurrentTransform();//todo
    }
}
...
uint32_t GLConsumer::getCurrentScalingMode() const {
    ...
    {
        return mConsumer->getCurrentScalingMode();//todo
    }
}
...
status_t GLConsumer::setCrop(const Rect& crop) {
