...
int VirtualDisplaySurface::setParameter(uint32_t cmd,uint32_t value){
	ALOGD("VirtualDisplaySurface setParameter");
	return 0;
}

uint32_t VirtualDisplaySurface::getParameter(uint32_t cmd){
	ALOGD("VirtualDisplaySurface getParameter");
	return 0;
}

status_t VirtualDisplaySurface::setCrop(const Rect& reg){
	ALOGD("VirtualDisplaySurface setCrop");
	return 0;
}

status_t VirtualDisplaySurface::setCurrentTransform(uint32_t transform){
	ALOGD("VirtualDisplaySurface setCurrentTransform");
	return 0;
}

status_t VirtualDisplaySurface::setCurrentScalingMode(int scalingMode){
	ALOGD("VirtualDisplaySurface setCurrentScalingMode");
	return 0;
}

status_t VirtualDisplaySurface::setTimestamp(int64_t timestamp){
	ALOGD("VirtualDisplaySurface setTimestamp");
	return 0;
}
