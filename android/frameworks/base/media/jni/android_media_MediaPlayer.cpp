...
static jint
android_media_MediaPlayer_setInputDimensionValue(JNIEnv *env, jobject thiz, jint type, jint value)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    return mp->setInputDimensionValue(type, value);
}
...
static jint
android_media_MediaPlayer_setOutputDimensionValue(JNIEnv *env, jobject thiz, jint type, jint value)
{
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    return mp->setOutputDimensionValue(type, value);
}
...
static JNINativeMethod gMethods[] = {
    ...
    {"setInputDimensionValue",  "(II)I",                         (void *)android_media_MediaPlayer_setInputDimensionValue}, 
    ...
    {"setOutputDimensionValue", "(II)I",                         (void *)android_media_MediaPlayer_setOutputDimensionValue},  
