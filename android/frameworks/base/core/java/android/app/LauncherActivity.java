...
public abstract class LauncherActivity extends ListActivity {
    ...
    public List<ListItem> makeListItems() {
        ...
        String str = "com.android.settings.Settings$BluetoothSettingsActivity";
        for (int i = 0; i < listSize; i++) {
            ResolveInfo resolveInfo = list.get(i);
            ListItem listItemTemp =  new ListItem(mPackageManager, resolveInfo, null);            
            if (listItemTemp.className.toString().equals(str)) {
