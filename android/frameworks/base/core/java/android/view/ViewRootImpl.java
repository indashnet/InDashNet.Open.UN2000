...
public final class ViewRootImpl implements ViewParent,
    ...
    private void enableHardwareAcceleration(WindowManager.LayoutParams attrs) {
        ...
        if (SystemProperties.getBoolean("ro.hwa.force", false)) {
            int index;
            String pn;
            String str = "com.android.cts.acceleration";
            pn = mView.getContext().getPackageName();

            index = pn.indexOf(str);
            if (index == -1) {
                hardwareAccelerated= true;
            }
        }

        //2013-10-21 19:41:59 ,filter some packages
        {
            int index;
            String pn;
            String[] packages = new String[] {
                "softmaker.applications.planmaker",
                "softmaker.applications.presentations",
                "com.square_enix.million_cn",
                "air.com.forthedream.dreamworks"};
            pn = mView.getContext().getPackageName();
