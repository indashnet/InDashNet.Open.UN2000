...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        try {
            ...
            Slog.i(TAG, "Dynamic Power Manager Service");
            dpm = new DynamicPManagerService(context);
            ServiceManager.addService("dynamic_power", dpm);
		...
		//init start_shutdown every time
		Slog.d("System", "-^__^- -^__^- -^__^- sys.start_shutdown 0");
